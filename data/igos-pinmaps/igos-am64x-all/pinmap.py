...
# eth0 is intentionally the SECOND CPSW socket (port@2 / phys_port_name p2) and
# eth1 the first (port@1 / p1). Consistent across models: single-port models
# enable only port@2 (their sole NIC -> eth0), and dual-port models add port@1
# as eth1.
ETH_INTERFACES = {
    "eth0": {
